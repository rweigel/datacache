...
var testsuite =
	[
		"test.js --sync=true  --start=0 --all=true --n=" + n + " --server=" + argv.server + " --serverdata="+argv.server, 
		"test.js --sync=false  --start=0 --all=true --n=" + n + " --server=" + argv.server + " --serverdata="+argv.server, 
		"test.js --sync=true --start=0 --all=true --n=" + n + " --server=" + argv.server + " --serverdata="+argv.serverdata, 
		"test.js --sync=false --start=0 --all=true --n=" + n + " --server=" + argv.server + " --serverdata="+argv.serverdata, 
	]
}

var testsuite =
		[
			"test.js --type " + type + " --sync true  --start "+argv.start+" --all " + argv.all + " --n " + n + " --server " + server + " --serverdata "+server, 
			"test.js --type " + type + " --sync false --start "+argv.start+" --all " + argv.all + " --n " + n + " --server " + server + " --serverdata "+server
		]
