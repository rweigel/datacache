...
j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/file1.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterReadStart=360&streamFilterReadLines=1&streamFilterWriteTimeFormat=1";
tests[j].n    = n || 50;
tests[j].md5  = "6e6f9f545e1e4a9db5e3bea91609b4e5";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/file1.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterReadStart=360&streamFilterReadLines=1&streamFilterWriteTimeFormat=0";
tests[j].n    = n || 50;
tests[j].md5  = "755c81782ceb9bf9a391daee92ee2396";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/file1.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=false&forceWrite=false&streamFilterReadStart=360&streamFilterReadLines=1&streamFilterWriteTimeFormat=0";
tests[j].n    = n || 50;
tests[j].md5  = "755c81782ceb9bf9a391daee92ee2396";
...
j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=mean";
tests[j].n    = n || 50;
tests[j].md5  = "f2ccf3160211039093c8029eccb9d533";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1withNaN.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=stats&streamFilterWriteComputeFunctionExcludes=99999,9999,999,99";
tests[j].n    = n || 50;
tests[j].md5  = "e585ef1aef0f3ee561b23613205e8396";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1withNaN.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=Nvalid&streamFilterWriteComputeFunctionExcludes=99999,9999,999,99";
tests[j].n    = n || 50;
tests[j].md5  = "b36ef7925e883243b2779b8517991603";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1withNaN.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=max&streamFilterWriteComputeFunctionExcludes=99999,9999,999,99";
tests[j].n    = n || 50;
tests[j].md5  = "5bfe3b84476742c44bf0bc849e9d62cf";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1withNaN.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=min&streamFilterWriteComputeFunctionExcludes=99999,9999,999,99";
tests[j].n    = n || 50;
tests[j].md5  = "7b24fca04785d3d5a6c78266fb18d2c0";

j = j+1;
tests[j]      = {};
tests[j].url  = server + "sync?source="+server+"test/data/filetoaverage1withNaN.txt&return=stream&lineRegExp=^[0-9]&streamFilterReadTimeFormat=DD-MM-YYYY,HH:mm:ss.SSS&streamFilterReadColumns=1,2,3,4,5,6&forceUpdate=true&forceWrite=true&streamFilterWriteTimeFormat=1&streamFilterWriteComputeFunctionWindow=2&streamFilterWriteComputeFunction=std&streamFilterWriteComputeFunctionExcludes=99999,9999,999,99";
tests[j].n    = n || 50;
