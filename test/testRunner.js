...
// node testRunner.js --n 1 --start 2 --all false --type stream
// node testRunner.js --n 1 --start 2 --all false --type api
...
var testsuite =
		[
			"testRunner.js --type " + type + " --sync true  --start "+argv.start+" --all " + argv.all + " --n " + n + " --server " + server + " --serverdata "+server, 
			"testRunner.js --type " + type + " --sync false --start "+argv.start+" --all " + argv.all + " --n " + n + " --server " + server + " --serverdata "+server
		]
